...
### 10.1 Data Persists After Restart
...
**Expected:** Previously added entry is shown.

### 10.2 Corrupted Vault File

**Steps:**

1. Create vault with entries
2. Corrupt file: `echo "garbage" > ~/.spm_vault`
3. Run `./spm list`

**Expected:** Shows authentication failed or error loading vault.
...
| Vault created with correct permissions | ☐    |
